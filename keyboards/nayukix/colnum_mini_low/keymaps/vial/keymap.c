...
/*Row0*/ KC_ESC,   KC_Q,    KC_L,    KC_U,     KC_COMM,       KC_DOT,                            KC_F,      KC_W,    KC_R,    KC_Y,    KC_P,    KC_BSLS,
/*Row1*/ KC_LCTL,  KC_E,    KC_I,    KC_A,     KC_O,          KC_MINS,                           KC_K,      KC_T,    KC_N,    KC_S,    KC_H,    KC_QUOT,
/*Row2*/ KC_LSFT,  KC_Z,    KC_X,    KC_C,     KC_V,          KC_SCLN,     KC_LALT,   KC_RALT,   KC_G,      KC_D,    KC_M,    KC_J,    KC_B,    KC_EQL,
/*Row3 */MO(FN),                     KC_LGUI,  KC_SPACE,      KC_SPACE,                          KC_ENTER,  KC_BSPC, MO(NUM),                   MO(FN)
    ),
    [MARK] = LAYOUT( 
       /* Col0      Col1           Col2            Col3            Col4            Col5           Col6      Col7        Col8         Col9            Col10        Col11          Col12        Col13  */
/*Row0*/ KC_GRAVE,  LSFT(KC_1),    LSFT(KC_2),     LSFT(KC_3),     LSFT(KC_4),     LSFT(KC_5),                          LSFT(KC_6),  LSFT(KC_7),     LSFT(KC_8),  LSFT(KC_9),    LSFT(KC_0),  LSFT(KC_BSLS),
/*Row1*/ KC_TAB,    KC_MINS,       KC_LBRC,        KC_RBRC,        LSFT(KC_COMM),  LSFT(KC_DOT),                        KC_LEFT,     KC_LEFT,        KC_DOWN,     KC_UP,         KC_RGHT,     LSFT(KC_QUOT),
/*Row2*/ _______,   LSFT(KC_MINS), LSFT(KC_LBRC),  LSFT(KC_RBRC),  LSFT(KC_9),     LSFT(KC_0),     _______,  _______,    KC_GRAVE,    LSFT(KC_GRAVE), KC_BSLS,     LSFT(KC_BSLS), KC_EQL,      LSFT(KC_EQL),
...
/*Row2*/ C(KC_S),  C(KC_Z),   C(KC_X),  C(KC_C),   C(KC_V),   G(KC_V),     _______,     _______,     _______,    _______,    _______,    _______,    _______,   LSG(KC_S),
/*Row3*/ _______,                       _______,   _______,   _______,                               _______,    _______,    _______,                           _______
    ),
  [NUM] = LAYOUT(
       /* Col0     Col1       Col2       Col3      Col4      Col5          Col6         Col7        Col8        Col9        Col10       Col11       Col12       Col13  */
/*Row0*/ KC_NUM,   KC_1,      KC_2,     KC_3,      KC_4,      KC_5,                                 KC_6,       KC_7,       KC_8,       KC_9,       KC_0,       _______,
/*Row1*/ _______,  _______,   _______,  _______,   _______,   _______,                              _______,    KC_4,       KC_5,       KC_6,       _______,    _______,
/*Row2*/ _______,  _______,   _______,  _______,   _______,   _______,     _______,     _______,    _______,    KC_1,       KC_2,       KC_3,       _______,    _______,
/*Row3*/ _______,                       _______,   _______,   _______,                              _______,    KC_0,    _______,                            _______
    ),
   [EX1] = LAYOUT(
       /* Col0     Col1         Col2     Col3      Col4      Col5          Col6         Col7        Col8        Col9        Col10        Col11      Col12      Col13  */
...
void oled_write_layer_state(void) {
    ...
    switch(layer) {
        ...
        case NUM:
            ...
            break; 
        case EX1:
            oled_write_ln_P(PSTR("EX1"), false);
            break;
        case EX2:
            oled_write_ln_P(PSTR("EX2"), false);
            break;
        case EX3:
            oled_write_ln_P(PSTR("EX3"), false);
            break;
        default:
            oled_write_ln_P(PSTR("?"), false);
            break;
